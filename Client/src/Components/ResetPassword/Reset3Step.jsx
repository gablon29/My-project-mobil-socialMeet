...
export const Reset3Step = ({ password, setPassword, Code }) => {
  ...
  return (
    <View className="flex-1 items-center justify-start pt-10 bg-white">
      ...
      <View className="w-80 h-12 mb-5">
        <TextInput placeholder="   Repite la contraseña" placeholderTextColor="white" value={password} onChangeText={(text) => setPassword(text)} className="w-full rounded-full bg-naranja px-4 h-14 font-poppinsBold text-white" />
      </View>
