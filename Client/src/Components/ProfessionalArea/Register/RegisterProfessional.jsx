    ...
    return (
        <ScrollView className="bg-white">
            <View className="h-full">
                ...
                {render === 13 && <FormRegister setPhone={setPhone} setEmail={setEmail} setNombre={setNombre} setApellido={setApellido}  profile={profile} render={render} lugarAtencion={lugarAtencion} setLugarAtencion={setLugarAtencion} setRender={setRender} tipo={tipo} setCountry={setCountry} country={country} province={province} city={city} setProvince={setProvince} setCity={setCity} modalidad={`¿Dónde esta la dirección de tu ${"\n"} centro de peluquería?`} info={`Esta información será pública en tu ${"\n"} perfil como peluquero/a`}/>}
                ...
                {render === 15 && <FormRegister setPhone={setPhone} setEmail={setEmail} setNombre={setNombre} setApellido={setApellido}  profile={profile} setRender={setRender} setCountry={setCountry} country={country} province={province} setProvince={setProvince} lugarAtencion={lugarAtencion} setLugarAtencion={setLugarAtencion} render={render} tipo={tipo} modalidad={`¿Dónde das servicios de ${"\n"} peluquería a domicilio?`} info={`Esta información será pública en tu ${"\n"} perfil como peluquero/a`}/>}
                {render === 16 && <FormRegister setPhone={setPhone} setEmail={setEmail} setNombre={setNombre} setApellido={setApellido} city={city}  profile={profile} setCity={setCity} setRender={setRender} setCountry={setCountry} country={country} province={province} setProvince={setProvince} lugarAtencion={lugarAtencion} setLugarAtencion={setLugarAtencion} render={render} tipo={tipo}  modalidad={`¿Dónde das servicios de ${"\n"} peluquería a domicilio?`} info={`Esta información será pública en tu ${"\n"} perfil como peluquero/a`} />}
                ...
                {render === 21 && <AccountAccepted professionals={professionals} tipo={tipo} profile={profile}/>}
                {/* Educadores */}
                ...
                {/* Paseadores */}
                {render === 24 && <FormRegister setPhone={setPhone} setEmail={setEmail} setNombre={setNombre} setApellido={setApellido} profile={profile} tipo={tipo} setRender={setRender} country={country} city={city} province={province} setCountry={setCountry} setCity={setCity} setProvince={setProvince} info={`Esta información será pública en tu ${"\n"} perfil como peluquero/a`} modalidad={`¿Donde das tus servicios como ${"\n"} educador/a?`}/>}
            </View>
        </ScrollView>
    );
}
