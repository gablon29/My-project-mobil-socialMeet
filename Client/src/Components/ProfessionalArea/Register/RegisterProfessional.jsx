    ...
    return (
        <ScrollView className="bg-white">
            <View className="h-full">
                {render === 1 && <SelectProfessionalArea data={data} professionals={professionals} profileId={profile?.id} tipo={tipo} title={"Selecciona una especie"} setTipo={setTipo} register={register} text={`Selecciona un área${"\n"}profesional`} setRender={setRender} render={render}/>}
                ...
                {/* Paseadores */}
                {render === 24 && <FormRegister setPhone={setPhone} setEmail={setEmail} setNombre={setNombre} setApellido={setApellido} data={data} tipo={tipo} setRender={setRender} country={country} city={city} province={province} setCountry={setCountry} setCity={setCity} setProvince={setProvince} info={`Esta información será pública en tu ${"\n"} perfil como peluquero/a`} modalidad={`¿Donde das tus servicios como ${"\n"} educador/a?`}/>}
            </View>
        </ScrollView>
    );
}
