    ...
    return (
        <ScrollView className="bg-white">
            <View className="h-full">
                ...
                {render === 9 && <BirthDay fechaNacimiento={fechaNacimiento} setFechaNacimiento={setFechaNacimiento} setRender={setRender}/>}
                ...
                {render === 18 && <AddPicture tipo={tipo} fotoDoc={fotoDoc} setFo={setFo} setRender={setRender}/>}
                {render === 19 && <BirthDay fechaNacimiento={fechaNacimiento} tipo={tipo} setFechaNacimiento={setFechaNacimiento} setRender={setRender}/>}
                {render === 20 && <Description description={description} tipo={tipo} setDescription={setDescription} setRender={setRender}/>}
                {render === 21 && <AccountAccepted tipo={tipo} lugarAtencion={lugarAtencion} mascotasCuidar={mascotasCuidar} fotoDoc={fotoDoc} fechaNacimiento={fechaNacimiento} description={description}/>}
            </View>
        </ScrollView>
    );
}
