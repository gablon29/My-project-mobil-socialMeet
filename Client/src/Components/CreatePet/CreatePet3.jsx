...
export const CreatePet3 = ({ steps, setSteps, name, setName, weight, setWeight, age, setAge, breed, setBreed, sex, setSex }) => {
   ...
   return (
      <View className='w-screen h-screen'>
        {console.log('CREATE PET 3')}
         <Text className='font-poppinsBold text-center mt-16'>¿Cómo se llama tu mascota?</Text>
         <TextInput placeholder='' value={name} onChangeText={(text) => setName(text)} className='w-full rounded-full bg-gris h-10 px-4 mb-4' />
         <Text className='font-poppinsBold text-center'>Peso en KG</Text>
         <TextInput placeholder='' value={weight} onChangeText={(text) => setWeight(text)} className='w-full rounded-full bg-gris h-10 px-4 mb-4' />
         ...
         <View className='flex mt-3'>
            ...
            <View className='flex flex-row'>
               <View className='flex-1 mx-3'>
                  <TouchableOpacity onPress={() => setSex('Macho')} className='bg-gris rounded-full'>
                     <Text className='font-poppinsBold text-center'>Macho</Text>
                  </TouchableOpacity>
               </View>
               <View className='flex-1 mx-3'>
                  <TouchableOpacity onPress={() => setSex('Hembra')} className='bg-gris rounded-full'>
