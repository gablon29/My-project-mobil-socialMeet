...
const EditInfoProfile = ({navigation}) => {
    ...
    const handleEdit = async (firstName, lastName, phone, email, country, province, profilePic) =>{
        const profile = {firstName: firstName, lastName: lastName, phone: phone, email: email, country: country, province: province, profilePic: profilePic};
        ...
        <ScrollView>
            <View className="w-screen h-full bg-white items-center pt-10 mb-5">
                ...
                <Button 
                    ...
                    onPress={()=>handleEdit(firstName, lastName, phone, email, country, province, selImg.profile)}
                />
            </View>
        </ScrollView>
    )
