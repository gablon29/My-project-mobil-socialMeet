...
export const ChipWhopaws = () => {
  ...
  return (
    <ScrollView>
      ...
      <View className="mt-12 justify-between rounded-full bg-black p-4 mx-4 h-fit flex flex-row">
        <Text className="text-white text-3xl font-poppinsBol">14,99€</Text>
        <TouchableOpacity onPress={() => navigation.navigate('ConfigurateChip')} className='bg-naranja rounded-full py-2 px-4'>
